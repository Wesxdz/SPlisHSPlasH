...
#include "Exporter/ParticleExporter_OpenVDB.h"
...
void SimulatorBase::createExporters()
{
	...
	addParticleExporter("enableOpenVDBExport", "OpenVDB Exporter", "Enable/disable VTK export.", new ParticleExporter_OpenVDB(this));
